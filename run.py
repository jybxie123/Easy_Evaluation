...
parser.add_argument('--data', metavar='DIR', default='e:/working/EasyEval/dataset/', help='path to dataset')
parser.add_argument('--dataset-name', default='mnist', help='training dataset name',
                    choices=['mnist', 'mnist_raw', 'fashion_mnist', 'k_mnist'])
...
parser.add_argument('--save-dir', metavar='DIR', default='e:/working/EasyEval/checkpoints/', help='path to save checkpoints')
...
parser.add_argument('--scheduler', default='MultiStep', help='scheduler name', choices=[None, 'CosineAnnealing', 'MultiStep', 'Exponential'])  # <fix>
...
# get sinclr model, declare cla and con head
def load_model(args):
