...
parser.add_argument('--mnist-path', metavar='DIR', default='e:/working/EasyEval/dataset/',
...
parser.add_argument('--metaset-dir', metavar='DIR', default='e:/working/EasyEval/meta_set/MNIST',
